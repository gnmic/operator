...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PushSignatureSpec) DeepCopyInto(out *PushSignatureSpec) {
	*out = *in
	if in.SecretRef != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PushSignatureSpec.
func (in *PushSignatureSpec) DeepCopy() *PushSignatureSpec {
	if in == nil {
		return nil
	}
	out := new(PushSignatureSpec)
	in.DeepCopyInto(out)
	return out
}
