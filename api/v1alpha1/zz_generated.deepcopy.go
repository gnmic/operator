...
func (in *WebhookAuthSpec) DeepCopyInto(out *WebhookAuthSpec) {
	*out = *in
	if in.Bearer != nil {
		...
		*out = new(WebhookBearerAuthSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.Signature != nil {
		in, out := &in.Signature, &out.Signature
		*out = new(WebhookSignatureAuthSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WebhookBearerAuthSpec) DeepCopyInto(out *WebhookBearerAuthSpec) {
	*out = *in
	if in.TokenSecretRef != nil {
		in, out := &in.TokenSecretRef, &out.TokenSecretRef
		*out = new(v1.SecretKeySelector)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WebhookBearerAuthSpec.
func (in *WebhookBearerAuthSpec) DeepCopy() *WebhookBearerAuthSpec {
	if in == nil {
		return nil
	}
	out := new(WebhookBearerAuthSpec)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WebhookSignatureAuthSpec) DeepCopyInto(out *WebhookSignatureAuthSpec) {
	*out = *in
	if in.SecretRef != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WebhookSignatureAuthSpec.
func (in *WebhookSignatureAuthSpec) DeepCopy() *WebhookSignatureAuthSpec {
	if in == nil {
		return nil
	}
	out := new(WebhookSignatureAuthSpec)
