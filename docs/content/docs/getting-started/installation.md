...
kubectl delete -f https://github.com/gnmic/operator/releases/latest/download/install.yaml
...
```bash
kubectl delete -f https://github.com/gnmic/operator/releases/latest/download/crds.yaml
```
