...
curl -X POST "http://localhost:8082/api/v1/namespaceCluster/namegNMIcCluster/createTargets" -H "Content-Type: application/json" -d '{"TargetSourceName":"sourcename", "TargetSourceNameSpace":"namespace", "TargetList": [{"Address":"1.1.1.1", "Name": "Router1", "Operation":""}]}'

## Empty TargetSourceName
curl -X POST "http://localhost:8082/api/v1/namespaceCluster/namegNMIcCluster/createTargets" -H "Content-Type: application/json" -d '{"TargetSourceName":"", "TargetSourceNameSpace":"namespace", "TargetList": [{"Address":"1.1.1.1", "Name": "Router1", "Operation":"create"}]}'